  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Visitor" do
        expect {
          post visitors_url, params: { visitor: valid_attributes }
        }.to change(Visitor, :count).by(1)
      end

      it "redirects to the created visitor" do
        post visitors_url, params: { visitor: valid_attributes }
        expect(response).to redirect_to(visitor_url(Visitor.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new Visitor" do
        expect {
          post visitors_url, params: { visitor: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested visitor" do
        visitor = Visitor.create! valid_attributes
        patch visitor_url(visitor), params: { visitor: new_attributes }
        visitor.reload
      ...
      it "redirects to the visitor" do
        ...
        patch visitor_url(visitor), params: { visitor: new_attributes }
        visitor.reload
        expect(response).to redirect_to(visitor_url(visitor))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        visitor = Visitor.create! valid_attributes
        patch visitor_url(visitor), params: { visitor: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
